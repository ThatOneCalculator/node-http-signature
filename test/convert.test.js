...
const sshKeyFingerprint = require("../lib/index").sshKeyFingerprint;
const sshKeyToPEM = require("../lib/index").sshKeyToPEM;
const pemToRsaSSHKey = require("../lib/index").pemToRsaSSHKey;

///--- Globals
const SSH_1024 =
	"ssh-rsa AAAAB3NzaC1yc2EAAAABIwAAAIEAvad19ePSDckmgmo6Unqmd8" +
...
const SSH_2048 =
	"ssh-rsa AAAAB3NzaC1yc2EAAAABIwAAAQEAr+isTwMYqwCAcY0Yb2F0pF" +
...
const SSH_4096 =
	"ssh-rsa AAAAB3NzaC1yc2EAAAABIwAAAgEAsWUdvcKBBjW4GJ8Uyo0S8U" +
...
const DSA_1024 =
	"ssh-dss AAAAB3NzaC1kc3MAAACBAKK5sckoM05sOPajUcTWG0zPTvyRmj6" +
...
test("fingerprint", function (t) {
	const fp = sshKeyFingerprint(SSH_1024);
